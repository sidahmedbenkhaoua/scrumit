...
@XmlRootElement
@Table(name = "tast_status_line", schema = "scrum_it", catalog = "scrum_it")
public class TastStatusLine extends ScrumItEntity implements Serializable {
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        TastStatusLine that = (TastStatusLine) o;
